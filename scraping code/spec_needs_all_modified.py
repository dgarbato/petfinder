...
first_page =r'https://www.petfinder.com/search/cats-for-adoption/us/ny/new-york-city/?attribute%5B0%5D=Special+needs&distance=25'
    ...
    try:
        ...
        for cat_url in CatsList:
            try:
                ...
                cat_dict['days_on_petfinder'] = 'special_needs_all'
                cat_dict['special_needs'] = 'All'
